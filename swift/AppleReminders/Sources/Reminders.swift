...
func getReminderList() async throws -> [ReminderList] {
...
func getData() async throws -> RemindersData {
    let eventStore = EKEventStore()
...
func getCompletedReminders(listId: String?) async throws -> [Reminder] {
    let eventStore = EKEventStore()
...
func createReminder(newReminder: NewReminder) async throws -> Reminder {
    let eventStore = EKEventStore()
...
func setTitleAndNotes(payload: SetTitleAndNotesPayload) throws {
    let eventStore = EKEventStore()
...
func toggleCompletionStatus(reminderId: String) throws {
    let eventStore = EKEventStore()
...
func setPriorityStatus(payload: SetPriorityStatusPayload) throws {
    let eventStore = EKEventStore()
...
func setDueDate(payload: SetDueDatePayload) throws {
    let eventStore = EKEventStore()
...
func setLocation(payload: SetLocationPayload)
async throws
{
    let eventStore = EKEventStore()
